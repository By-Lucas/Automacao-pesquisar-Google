#PEsquisar informacoes no google e salvar em um documento txt
#Digite o que quer e em seguida as pginas que deseja que o BOT faça as buscas
...
with open("Pesquisar e salvar/resultados.txt","w") as arquivo:
